...
const DasrsSidebar = ({ isOpened = false, onToggle = () => {}, data = [] }) => {
  ...
  const navBarSubIconActiveClass = "navbar-icon stroke-[2.5]";
  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`playersidebar-container bg-navbar-color text-off-white p-4 z-50 ${
                                      ...
                                      >
                                        {isSubActive
                                          ? React.cloneElement(subItem.icon, {
                                              className: `${navBarSubIconActiveClass}`,
                                            })
                                          : React.cloneElement(subItem.icon, {
                                              className: navBarIconHoverClass,
                                            })}
