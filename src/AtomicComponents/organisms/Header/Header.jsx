      ...
      <div className="flex items-center group">
        ...
        <div
          ...
          <ul className="flex gap-2">
            <li
              ...
              >
							<Link className="relative px-standard-x block leading-8 before:absolute before:top-0 before:left-0 before:z-[-1] before:h-full before:w-0
        ...
        <button
          ...
          className="bg-gray-main w-18 h-18 rounded-full flex items-center justify-center z-1 group"
				>
          <SidebarIcon className="w-6 h-6 group-hover:rotate-360 group-hover:scale-150 transition ease-[cubic-bezier( 0.68, 0.19, 0.45, 0.82 )] duration-700" color={"white"} />
        </button>
      </div>
    </div>
  );
