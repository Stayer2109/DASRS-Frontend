...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/AtomicComponents/atoms/shadcn/card";
import { Button } from "@/AtomicComponents/atoms/shadcn/button";
import { useNavigate } from "react-router-dom";
import { ChartBarIcon, CalendarIcon, UsersIcon, XMarkIcon } from "@heroicons/react/24/outline";

export const TournamentNavCards = ({ tournamentId, tournamentName, onClose }) => {
  const navigate = useNavigate();
  
  const navOptions = [
    {
      title: "Leaderboard",
      description: "View tournament standings and team rankings",
